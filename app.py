...
# --- MAIN APP ---
st.title("> QUANT_PARLAY_ENGINE_V25")
...
with tab_build:
    ...
    # --- MAIN TABLE (LOOP FIX: REMOVED MANUAL CHECK) ---
    st.data_editor(
...
with tab_ledger:
    ...
    if not st.session_state.bet_history.empty:
        ...
        # Double-Click Fix Logic for Ledger (Safe to keep manual check here as it has no callback)
